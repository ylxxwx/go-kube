...
import (
	...
	"github.com/ylxxwx/go-kube/crd_3/pkg/generated/informers/externalversions/foogroup/v1alpha1"
	foolisters "github.com/ylxxwx/go-kube/crd_3/pkg/generated/listers/foogroup/v1alpha1"
)
...
type Controller struct {
	...
	nsLister  foolisters.FooLister
	nsSynced  cache.InformerSynced
	workqueue workqueue.RateLimitingInterface
	recorder  record.EventRecorder
}

func NewController(ccs *kubernetes.Clientset, cs *versioned.Clientset, informer v1alpha1.FooInformer) *Controller {
	eventBroadcaster := record.NewBroadcaster()
	eventBroadcaster.StartStructuredLogging(0)
	eventBroadcaster.StartRecordingToSink(&typedcorev1.EventSinkImpl{Interface: ccs.CoreV1().Events("")})
