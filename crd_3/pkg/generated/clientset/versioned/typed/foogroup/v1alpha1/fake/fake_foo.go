...
type FakeFoos struct {
	Fake *FakeFoogroupV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "foogroup.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "foogroup.k8s.io", Version: "v1alpha1", Kind: "Foo"}
