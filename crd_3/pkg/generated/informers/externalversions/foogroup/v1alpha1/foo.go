...
import (
	...
	foogroupv1alpha1 "github.com/ylxxwx/go-kube/crd_3/pkg/apis/foogroup/v1alpha1"
	versioned "github.com/ylxxwx/go-kube/crd_3/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/ylxxwx/go-kube/crd_3/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/ylxxwx/go-kube/crd_3/pkg/generated/listers/foogroup/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FoogroupV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FoogroupV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&foogroupv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foogroupv1alpha1.Foo{}, f.defaultInformer)
}
